...
path=/home/inception/public_html
url="cmarien.42.fr"
...
{
	cp ~/wp-config-template.php /home/inception/public_html/wp-config.php
	sed -i "s/__DB_NAME__/${DB_NAME}/g" /home/inception/public_html/wp-config.php
	sed -i "s/__DB_PSWD__/${DB_PSWD}/g" /home/inception/public_html/wp-config.php
	sed -i "s/__DB_USER__/${DB_USER}/g" /home/inception/public_html/wp-config.php
	cat /home/inception/public_html/wp-config.php
}
